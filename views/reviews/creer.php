...
<div class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="/f1_2026/index.php?page=gerer_reviews" class="nav-item">
            <svg class="nav-icon" viewBox="0 0 24 24"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg>
            Gérer les reviews
        </a>
    </nav>
    ...
    <div class="topbar">
        ...
        <div class="topbar-right">
            <div class="admin-topbadge">
                <svg style="width:12px;height:12px;fill:none;stroke:currentColor;stroke-width:1.5" viewBox="0 0 24 24"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>
                Accès Admin
            </div>
        </div>
    </div>
...
<script>
    ...
    const gpData = {
        "Australian Grand Prix":      { round: "Round 01", ville: "Melbourne" },
        ...
        "Mexico City Grand Prix":     { round: "Round 18", ville: "Mexico" },
        "São Paulo Grand Prix":       { round: "Round 19", ville: "São Paulo" },
        "Las Vegas Grand Prix":       { round: "Round 20", ville: "Las Vegas" },
        "Qatar Grand Prix":           { round: "Round 21", ville: "Lusail" },
        "Abu Dhabi Grand Prix":       { round: "Round 22", ville: "Abu Dhabi" }
    };
    ...
    function updatePreview() {
        ...
        const now = new Date();
        document.getElementById('p-date').textContent = now.toLocaleDateString('fr-FR', { day: 'numeric', month: 'short' });
    }
