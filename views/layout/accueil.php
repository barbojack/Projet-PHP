...
<div class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <?php if (isset($_SESSION["user_id"])): ?>
            <a href="index.php?page=deconnexion" class="nav-item">
        ...
        <?php else: ?>
            <a href="index.php?page=connexion" class="nav-item">
        ...
        <?php if (isset($_SESSION["isAdmin"]) && $_SESSION["isAdmin"] == 1): ?>
            ...
            <a href="index.php?page=creer_review" class="nav-item">
                <svg class="nav-icon" viewBox="0 0 24 24"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>
                Nouvelle review
            </a>
            <a href="index.php?page=gerer_reviews" class="nav-item">
    ...
    <div class="content">
        ...
        <div>
            <div class="section-header">
                ...
                <a href="index.php?page=resultats" class="see-all">Voir tous les résultats ›</a>
            </div>
        ...
        <div>
            <div class="section-header">
                ...
                <a href="index.php?page=reviews" class="see-all">Toutes les reviews ›</a>
            </div>
            <a href="index.php?page=review_detail&id=<?= $derniereReview["id"] ?>" class="review-banner">
                <div>
